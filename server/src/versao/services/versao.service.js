...
exports.createVersao = async function (versao) {
  ...
  var newVersao = new Versao({
    ...
    dataPublicacao: versao.dataPublicacao,
    dataRelease: versao.dataRelease,
    tickets: versao.tickets
  });
...
exports.updateVersao = async function (versao) {
  ...
  oldVersao.dataPublicacao = versao.dataPublicacao;
  oldVersao.dataRelease = versao.dataRelease;
  oldVersao.tickets = versao.tickets;
